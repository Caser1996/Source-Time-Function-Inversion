function h = patch_plot(time,data,offset,upcolor,dncolor,isupfill,isdnfill )
%SINGLE_WIG2 Summary of this function goes here
%   Detailed explanation goes here
% Recieved from Xu 2022
...
[t0,d0] = curveintersect(time, data, time, zeros(size(time))); % find the 0 crossing
